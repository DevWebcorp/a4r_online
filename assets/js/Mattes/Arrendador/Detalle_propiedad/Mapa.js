...
function initAutocomplete() {
    console.log("esta es el autocomplete");
...
function initMap(lat, lng, uni_lat, uni_long) {
    var marker;
    let map;
    ...
    if (uni_lat && uni_long) {
        ...
        console.log("DATOS: "+ lat + " "+ lng +" " + uni_lat + " " + uni_long);
...
function  getCordenadas(){
    if ($("#direccion").val().length < 1) {
        ...
        var loginForm = $("#upd_ubicacion").serializeArray();
        var loginFormObject = {};
        $.each(loginForm,
            function(i, v) {
