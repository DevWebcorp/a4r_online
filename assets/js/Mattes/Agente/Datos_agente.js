...
$(document).ready(function() {
    $(document).on('submit', '#alta_agente', function() {
        ...
        if (pass1 == pass2) {
            ...
            const url = `${BASE_URL}Mattes/Api/Agente_api/Datos_agente/update_agente`;
...
$(document).ready(function() {
    ...
    const url = `${BASE_URL}Mattes/Api/Agente_api/Datos_agente`;
    ...
    $.ajax({
        ...
        success: function(res) {
            ...
            $('#loader').toggle();
            if (res.photo != "") {
                document.getElementById("img").src = BASE_URL+"/writable/uploads/Mattes/Agente/" + res.photo;
            }
