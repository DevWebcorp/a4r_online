                    ...
                    <form id="detalle-propiedad" enctype="multipart/form-data" class="mb-5">
                        <div class="row mg-t-20 ">
                            <div class="col-lg-7 form__group">
                                <input type="text" class="form__input" required id="nombre_propiedad" name="nombre_propiedad" pattern="[a-zA-ZñÑáéíóúÁÉÍÓÚ-z0-9\s]+" minlength="5" maxlength="30" autocomplete="off" placeholder=" ">
                        ...
                        <div class="row mg-t-40 ">
                            <div class="col-lg-7 form__group">
                                <textarea class="form__input" id="descripcion" required name="descripcion" pattern="[a-zA-ZñÑáéíóúÁÉÍÓÚ-z0-9\s]+" minlength="5" maxlength="250" autocomplete="off" placeholder=" "></textarea>
                        ...
                        <div class="row mg-t-40 ">
                            <div class="col-lg-7 form__group">
                                <input type="date" id="disponibilidad" required name="disponibilidad" class="form__input" placeholder=" ">
                        ...
                        <div class="row mg-t-40 ">
                            <div class="col-lg-7 form__group">
                                <select id="tipo-alojamiento" required name="tipo_alojamiento" class="form__input select2">
                                </select>
