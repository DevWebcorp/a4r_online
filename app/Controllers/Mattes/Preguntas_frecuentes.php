...
class Preguntas_frecuentes extends BaseController {
    public function index() {
        ...
        if($acceso){
            ...
            switch ($type_group) {
                case 1:
                    $data_header['styles'] = ["starlight.css", "Mattes/Principal.css", "Mattes/Login.css", "Mattes/Back_office/MenuBO.css"];
                ...
                case 4:
                    ...
                    $data_header['styles'] = ["starlight.css", "Mattes/Principal.css", "Mattes/Login.css", "Mattes/Arrendatario/Menu_arrendatario.css"];
                ...
                case 5:
                    ...
                    $data_header['styles'] = ["starlight.css", "Mattes/Principal.css", "Mattes/Login.css", "Mattes/Arrendador/Menu_arrendador.css"];
        ...
        echo view('Mattes/Preguntas_frecuentes');
