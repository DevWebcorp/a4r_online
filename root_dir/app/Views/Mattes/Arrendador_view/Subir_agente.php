    ...
    <div class="row d-empresa">
        <div class="col-12">
            <div class="tab datos-empresa d-flex flex-column flex-md-row  justify-content-center">
              <!--   <button style="display: none;" class="tablinks " onclick="openCity(event, 'Personales')" id="defaultOpen"><i class="fa fa-user mr-2" aria-hidden="true"></i>Datos personales</button>
            ...
            <div id="Personales" class="tabcontent mb-430 mb-sm-360 mb-md-280 mb-lg-270 mb-xl-250">
        ...
        ===== DATOS BANCARIOS =====
      =============================================-->
            <div id="Bancarios" class="tabcontent mg-b-120 ">
                <div class="card form-layout" style="border: none;">
                    <div class="text-center">
                        <h3 class="datos-bancarios-empresa mb-sm-5"> Datos bancarios </h3>
                    </div>
                    <form class="" id="form_bancarios_inmobiliaria" enctype="multipart/form-data">
                        <div class="row justify-content-center mg-t-20">
                            <div class="col-lg-7 form__group px-sm-4">
                                ...
                                <label class="form__label px-sm-2">Nombre<span class="tx-danger">*</span></label>
                                <div class="requirements">
                                    Tiene que tener mínimo 3 caracteres
                                </div>
                            </div>
                        ...
                        <div class="row justify-content-center mg-t-40">
                            <div class="col-lg-7 form__group px-sm-4">
                                ...
                                <label class="form__label px-sm-2">Banco<span class="tx-danger">*</span></label>
                                <div class="requirements">
                        ...
                        <div class="row justify-content-center mg-t-40">
                            <div class="col-lg-7 form__group px-sm-4">
                                ...
                                <label class="form__label px-sm-2">CLABE<span class="tx-danger">*</span></label>
                                <div class="requirements">
      ...
      =============================================-->
            <div id="Fiscales" class="tabcontent mg-b-60 mb-sm-3">
                <div class="card form-layout" style="border: none;">
                    <div class="text-center">
                        <h3 class="datos-fiscales-empresa mb-5"> Datos fiscales </h3>
                    </div>
                    <form class="" id="form_fiscales" enctype="multipart/form-data">
                        ...
                        <div class="row justify-content-center mg-t-40">
                            <div class="col-lg-7 form__group px-sm-4">
                                ...
                                <label class="form__label px-sm-2">Dirección fiscal<span class="tx-danger">*</span></label>
                                <div class="requirements">
...
<div id="updateModal" class="modal fade">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content tx-size-sm">
            <div class="modal-header pd-x-20" style="background-color: #EAA654;">
            ...
            <form id="formUpdate" enctype="multipart/form-data">
                <div class="pd-20">
                    <div class="pd-20 pd-sm-40" style="height: auto !important;">
            ...
            <p class="mg-b-20 mg-sm-b-30">Rellena todos los campos</p> -->
                        <div class="form-layout">
                            <div class="row mg-b-25">
                                ...
                                <div class="row">
                                    <div class="col-lg-7 ml-3 mg-t-20 mg-sm-t-0">
                                        <label for="">Foto: <span class="tx-danger">*</span></label>
                                        <div class="file-drop-area">
                                            <span class="choose-file-button">Subir foto de perfil</span>
                                            <span class="file-message">Arrastra el archivo aqui</span>
