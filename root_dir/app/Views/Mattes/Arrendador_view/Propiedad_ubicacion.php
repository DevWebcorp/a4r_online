                        ...
                        <div class="col-lg-5">
                            ...
                            <div class="col-lg-4">
                                ...
                                <div class="col-12 col-lg-9 mg-t-10 mg-sm-t-0 ml-5-5">
                                    <div class="input-group">
                                        <input type="text" name="universidad" id="autoComplete" class="" autocomplete="off" placeholder=" " required style="background-color: white !important; color: rgba(0,0,0,.8) !important; border: 1px solid #28a745 !important;">
