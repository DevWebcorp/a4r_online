        ...
        <div class="row " style="margin-top: 135px;">
            ...
            <div class="col-12">
                <form class=" " id="propiedad_ubicacion">
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="row justify-content-center mg-t-40">
                                <div class="col-lg-9">
                                    <label class="col-12 px-0 form-control-label">Código postal <span class="text-danger">*</span></label>
                            ...
                            <div class="row justify-content-center mg-t-20">
                                <div class="col-lg-9">
                                    <label class="col-12 form-control-label px-0">Dirección [calle, número, colonia, CP, estado]<span class="text-danger">*</span></label>
                                    <div class="input-group col-12 px-0 mg-t-10 mg-sm-t-0">
                                        <input type="text" class="form-control" id="direccion" name="direccion" aria-describedby="button-addon2" placeholder=" " required>
                        ...
                        <div class="col-lg-5">
                            <div class="row mg-t-40 mt-lg-60">
                                <div class="col-lg-9 form__group">
                                    <input type="text" name="precio" min="0" pattern="[0-9]+,[0-9]+.[0-9]+" class="form__input" placeholder=" " id="precio" pattern="[0-9]+)?" minlength="4" maxlength="8" title="Solo se permiten números" required>
                                    <label for="precio" class="form__label">Precio<span class="text-danger">*</span></label>
                            ...
                            <div class="row mg-t-40">
                                <div class="col-lg-9 form__group">
                                    <select class="form__input select2" name="habita_propiedad" id="h_propiedad" required>
                                        <option value="">Selecciona </option>
                                        <option value="Si">Si</option>
                                        <option value="No">No</option>
                                    </select>
                                    <label class="form__label">Usted vive en la propiedad<span class="text-danger">*</span></label>
                                </div>
                            </div>
                            <div class="row mg-t-20">
                                <label class="col-12 col-lg-9  form-control-label mx-auto">Universidad más cercana<span class="text-danger">*</span></label>
                                <div class="col-12 col-lg-9 mg-t-10 mg-sm-t-0 ml-5-5">
                                    <div class="input-group">
                                        <input type="text" name="universidad" id="autoComplete" class="form-control" autocomplete="off" placeholder=" " required style="background-color: white !important; color: rgba(0,0,0,.8) !important; border: 1px solid #28a745 !important;">
                                        <input type="hidden" name="id_univ" id="univ" class="form-control ">
                                    </div>
                                </div>
                            </div>
                            <div class="row mg-t-40">
                                <div class="col-12 col-lg-9 form__group mb-4">
                                    <input type="text" id="distancia" name="distancia" class="form__input" placeholder=" " readonly required style="background-color: #e9ecef;">
                                    <label class="form__label">Distancia<span class="text-danger">*</span></label>
                                </div>
                            </div>
                    ...
                    <div class="col-12 col-lg-11 mx-auto mt-3 mt-lg-5 px-0 pl-lg-4 pr-lg-3">
                    ...
                    <div class="col-12 col-lg-11 row mx-auto px-0 text-md-right mt-5">
                        <div class="col-12 text-center text-md-right px-0 pr-lg-3">
                            <div class="d-flex flex-column flex-sm-row justify-content-end">
                                <button class="btn-danger mr-sm-2 mb-2 mb-sm-0 px-4 py-1" id="submit_ficha">
                                ...
                                <button type="submit" class="btn-primary px-4 py-1">
