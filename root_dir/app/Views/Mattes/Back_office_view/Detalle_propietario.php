...
<div class="mb-120 mt-4">
    ...
    <div class="container">
        ...
        <div id="Estatus" class="tabcontent">
            <form id="formStatus">
                <div class="form-layout text-center justify-content-center" style="height: auto; border: none;">
        ...
        <div id="Bancarios" class="tabcontent">
            <div class="container mb-5">
                <div class="row">
                    <div class="col-12">
                        <div class="form-layout" style="height: auto; border: none;">
                            <!-- <div class="text-center">
                            ...
                            <form class="" id="form-bancarios" enctype="multipart/form-data">
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        <label class="">Nombre<span class="tx-danger">*</span></label>
                                        <input id="name_bancario" type="text" class="" id="nombre_bancario" name="name_bancario" placeholder=" " required pattern="[a-zA-ZñÑáéíóúÁÉÍÓÚ\s]+" minlength="2" maxlength="60" aria-describedby="passwordHelpBlock">
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        <label class="">Banco<span class="tx-danger">*</span></label>
                                        <input id="name_bank" type="text" id="nombre_banco" name="nombre_banco" class="" placeholder=" " required pattern="[A-Za-z\s]+" minlength="4" maxlength="30">
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        <label class="">CLABE<span class="tx-danger">*</span></label>
                                        <input id="clabe" type="text" class="" id="clabe_bancaria" name="clabe_bancaria" placeholder=" " pattern="^[0-9]+" minlength="18" maxlength="18" required>
                                        <input id="id_usuarioban" type="hidden" name="id_usuarioban">
                                    </div>
                                </div>
                                <div class="col-lg-12 row px-0 px-lg-2 mt-3">
                                    <div class="col-sm-12 text-center text-md-right px-0">
                                        <div class="d-flex flex-column flex-sm-row justify-content-end">
                                            <button class="btn btn-teal px-4 py-1" type="submit"><i class="fa fa-pencil fa-lg mr-1" aria-hidden="true"></i>Actualizar</button>
                                        </div>
        ...
        <!--=========================================
                    ===== DATOS FISCALES =====
                =============================================-->
        <div id="Fiscales" class="tabcontent mb-5">
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        <div class="form-layout" style="height: auto; border: none;">
                            ...
                            <form class="" id="form-fiscales" enctype="multipart/form-data">
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input id="rfc" type="text" class="" id="rfc_fiscal" name="rfc" placeholder=" " pattern="^([A-ZÑ\x26]{3,4}([0-9]{2})(0[1-9]|1[0-2])(0[1-9]|1[0-9]|2[0-9]|3[0-1]))([A-Z\d]{3})" minlength="12" maxlength="13" required>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        <label class="">Dirección fiscal<span class="tx-danger">*</span></label>
                                        <input id="fiscal" type="text" class="" id="dir_fiscal" name="direccion_fiscal" placeholder=" " pattern="^[A-Za-z0-9\s]+" minlength="13" maxlength="100" required>
