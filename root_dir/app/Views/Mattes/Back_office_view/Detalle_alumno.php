...
<section class="alumno-detalle mg-t-90">
    <div class="container">
        <div class="row">
            <div class="col-12">
                <h3 class="text-center mt-5 mb-4">Detalle de alumno</h3>
                        ...
                        <div class="container">
                            <div class="row">
                                <div class="col-lg-12 px-0 mb-5">
                                    ...
                                    <div class="col-sm-12 pr-lg-0 mg-t-10 mg-sm-t-10 ml-lg-5">
                                        <div class="file-drop-area mx-auto">
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <input id="nombre" type="text" class="" placeholder=" " required name="nombre" pattern="[a-zA-ZñÑáéíóúÁÉÍÓÚ\s]+" minlength="3" maxlength="25" aria-describedby="passwordHelpBlock" title="Solo se permiten letras" style="background-color: #e9ecef;" readonly>
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        <label class="form-label">Primer apellido<span class="tx-danger">*</span></label>
                                        <input id="primer_apellido" type="text" class="" placeholder=" " style="background-color: #e9ecef; " required name="primer_apellido" pattern="[a-zA-ZñÑáéíóúÁÉÍÓÚ\s]+" minlength="3" maxlength="25" aria-describedby="passwordHelpBlock" title="Solo se permiten letras" readonly>
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                    <div class=" form-group">
                                        <label class="">Segundo apellido<span class="tx-danger">*</span></label>
                                        <input id="segundo_apellido" type="text" class="" placeholder=" " required name="segundo_apellido" pattern="[a-zA-ZñÑáéíóúÁÉÍÓÚ\s]+" minlength="3" maxlength="25" aria-describedby="passwordHelpBlock" title="Solo se permiten letras" style="background-color: #e9ecef;" readonly>
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        <label class="">Correo</label>
                                        <input id="correo" type="text" class="" placeholder=" " required name="correo" pattern="[a-zA-ZñÑáéíóúÁÉÍÓÚ\s]+" minlength="3" maxlength="25" aria-describedby="passwordHelpBlock" title="Solo se permiten letras" style="background-color: #e9ecef;" readonly>
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                    <div class="form-group">
                                    <label class="" for="celular">Número de celular<span class="tx-danger">*</span></label> 
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        <label class="form-label">Fecha de nacimiento<span class="tx-danger">*</span></label>
                                        <input id="f_nacimiento" type="date" class="" placeholder="Ingresar fecha de nacimiento" required name="f_nacimiento" pattern="^[0-9]+" minlength="10" maxlength="10" aria-describedby="passwordHelpBlock" title="Solo se permiten numeros">
                                    </div>
                                </div>

                                 <div class="col-lg-12">
                                    <div class="form-group">
                                        <label class="">Describete</label>
                                        <textarea id="describete" class="" name="describete" placeholder=" " pattern="[a-zA-ZñÑáéíóúÁÉÍÓÚ\s]+" minlength="10" maxlength="140" aria-describedby="passwordHelpBlock" title="Solo se permiten letras"></textarea>
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        <label class="form-label">Sexo<span class="tx-danger">*</span></label>
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        <label class="">Universidad<span class="tx-danger">*</span></label>
                                        <input id="autoComplete" type="text" class="" placeholder=" " name="universidad" autocomplete="off" style="background-color: white !important; color: rgba(0,0,0,.8) !important;">
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <input id="carrera" type="text" class="" placeholder=" " name="carrera" autocomplete="off" pattern="[a-zA-ZñÑáéíóúÁÉÍÓÚ\s]+" minlength="3" maxlength="60" aria-describedby="passwordHelpBlock" title="Solo se permiten letras">
                                    </div>
                                </div>

                                <div class="col-lg-4">
                                    <div class="form-group">
                                        <label class="">¿De qué estado vienes?</label>
                                        <select id="estado" name="estado" class="" data-placeholder="Selecciona una opción">
                                            <option value="">Selecciona una opción</option>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="col-12 col-lg-4">
                                    <div class="form-group">
                                        <label class="">Credencial universidad (vigente)<span class="tx-danger">*</span></label>
                                        <div class="">
                                ...
                                <div class="col-lg-4">
                                    <label class="">Identificación oficial (pasaporte o INE)<span class="tx-danger">*</span></label>
                                    <div class="">
                                        <div class="col-sm-12 mg-t-10 mg-sm-t-0 pr-lg-4">
                                            <div class="file-drop-area">
                                                <span class="choose-file-button">Subir Archivo</span>
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        <label class="">Credencial universidad</label>
                                        <div class="">
                                ...
                                <div class="col-lg-12 row mx-auto px-0 mt-5 order-2">
                                    <div class="col-sm-12 text-center pl-lg-0">
                                ...
                                <div class="pd-20 pd-sm-40 pt-md-0 form-layout form-layout-4" style="border: none;">
                                    <form id="form_status" enctype="multipart/form-data">
                                        <div class="mg-t-20">
                                            ...
                                            <div class="col-lg-12 my-5 px-lg-0">
