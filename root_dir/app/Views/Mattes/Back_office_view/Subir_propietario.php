...
<div class="mb-120 mg-t-120">
        ...
        <div class="row d-empresa">
            <div class="col-12 mb-4">
                <div class="tab datos-propietario d-flex flex-column flex-lg-row justify-content-center">
                    <button class="tablinks" onclick="openCity(event, 'Personales')" id="defaultOpen"><i class="fa fa-address-card-o mr-2" aria-hidden="true"></i>Datos Personales</button>
                    ...
                    <button class="tablinks" onclick="openCity(event, 'Propiedad')" id="mensajes_chat"><i class="fa fa-home  mr-2" aria-hidden="true"></i>Datos propiedad</button>
                </div>
            </div>
        </div>
    </div>
                    ...
                    <form class="mb-200" id="form-personales" enctype="multipart/form-data">
                        ...
                        <div class="row justify-content-center mg-t-40">
                            <div class="col-lg-7 form__group">
                                <select id="tipo_arrendador" class="form__input" required name="tipo_arrendador">
                                    <option value="">ELIGUE UNA OPCION</option>
                                    <option value="1" title="1 a 2 propiedades">PROPIETARIO</option>
                                    <option value="2" title="+10 propiedades">INMOBILIARIA</option>
                                    <option value="3" title="2 a 10 propiedades">AGENTE INMOBILIARIO</option>
                                </select>
                                <label class="form__label">Tipo de arrendador<span class="tx-danger">*</span></label>
                        ...
                        <div class="row justify-content-center mg-t-40">
                            <div class="col-lg-7  form__group">
                                <input id="correo" type="email" class="form__input" placeholder=" " name="correo" required>
                        ...
                        <div class="col-lg-7 row mx-auto px-0 px-lg-2 mt-3">
                            <div class="col-sm-12 text-center text-md-right px-0">
                                <div class="d-flex flex-column flex-sm-row justify-content-end">
                                    <button class="btn btn-teal px-4 py-2" type="submit"><i class="fa fa-floppy-o fa-lg mr-1" aria-hidden="true"></i> Guardar</button>
                                </div>
                            </div>
                        </div>
                    </form>
                        ...
                        <div class="form-layout" style="border: none;">
                            ...
                            <form class="" id="form-bancarios" enctype="multipart/form-data">
                                ...
                                <div class="col-lg-7 row mx-auto px-0 px-lg-2 mt-3">
                                    <div class="col-sm-12 text-center text-md-right px-0">
                                        <div class="d-flex flex-column flex-sm-row justify-content-end">
                                            <button class="btn btn-teal px-4 py-1" type="submit"><i class="fa fa-floppy-o fa-lg mr-1" aria-hidden="true"></i> Guardar</button>
                                        </div>
                                    </div>
                                </div>
                            </form>
    ...
    =============================================-->
        ...
        <!--=========================================
            ===== DATOS PROPIEDADES  =====
        =============================================-->
        <div id="Propiedad" class="tabcontent height-mensajes-indep">
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        <div class="form-layout" style="border: none;">
                            <div class="text-center">
                                <h3 class="d-propiedad"> Datos Propiedad </h3>
                            </div>
                            <form id="detalle-propiedad" enctype="multipart/form-data" class="mb-5">
                                <div class="row mg-t-20 ">
                                    <div class="col-lg-7 form__group">
                                        <input type="text" class="form__input" id="nombre_propiedad" name="nombre_propiedad" pattern="[a-zA-ZñÑáéíóúÁÉÍÓÚ-z0-9\s]+" minlength="5" maxlength="30" autocomplete="off" placeholder=" ">
                                ...
                                <div class="row mg-t-40 ">
                                    <div class="col-lg-7 form__group">
                                        <textarea class="form__input" id="descripcion" name="descripcion" pattern="[a-zA-ZñÑáéíóúÁÉÍÓÚ-z0-9\s]+" minlength="5" maxlength="250" autocomplete="off" placeholder=" "></textarea>
                                ...
                                <div class="row mg-t-40 ">
                                    <div class="col-lg-7 form__group">
                                        <input type="date" id="disponibilidad" name="disponibilidad" class="form__input" placeholder=" ">
                                ...
                                <div class="row mg-t-40 ">
                                    <div class="col-lg-7 form__group">
                                        <select id="tipo-alojamiento" name="tipo_alojamiento" class="form__input select2">
                                        </select>
                                        <label class="form__label">Tipo de alojamiento</label>
                                    </div>
                                </div>

                                <input type="hidden" id="id_usuarioprop" name="id_propietario">
