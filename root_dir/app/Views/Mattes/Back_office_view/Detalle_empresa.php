...
<div class="container-fluid pd-80 pb-0 mt-lg-empresa">
...
<div class="container">
    <div class="row">
        <div class="col-12">
            <div id="Personales" class="tabcontent mb-500 mb-sm-360 mb-md-280 mb-lg-270 mb-xl-250">
                <div class="col-12 mb-430 mb-sm-410 mb-md-400 mb-lg-380 mb-xl-250">
                    <div class="card form-layout" style="border: none;">
                        <div class="text-center">
                            <h3 class="datos-personales-empresa">Ahora un poco de ti </h3>
                        ...
                        <form class="mb-430 mb-sm-360 mb-md-280 mb-lg-270 mb-xl-250" id="form_perso_emp" enctype="multipart/form-data">
                            <div class="row justify-content-center mg-t-20">
                                <div class="col-lg-7 form__group">
                                    <input type="text" class="form__input" id="inmobiliaria" name="nombre_inmobiliaria" pattern="[a-zA-ZñÑáéíóúÁÉÍÓÚ\s]+" minlength="3" maxlength="50" autocomplete="off" placeholder=" " required>
                                    <label class="form__label">Nombre inmobiliaria<span class="tx-danger">*</span></label>
                            ...
                            <div class="row justify-content-center mg-t-40">
                                <div class="col-lg-7 form__group">
                                    <input type="text" class="form__input" id="razonsocial" name="razonsocial_inmobiliaria" minlength="13" maxlength="100" autocomplete="off" placeholder=" " required>
                                    <label class="form__label">Razón social<span class="tx-danger">*</span></label>
                                    <div class="requirements">
                            ...
                            <div class="row justify-content-center mg-t-40">
                                <div class="col-lg-7 form__group">
                                    <input type="text" class="form__input" id="representante" name="representante_legal" minlength="13" maxlength="100" autocomplete="off" placeholder=" " required>
                                    <label class="form__label">Representante legal<span class="tx-danger">*</span></label>
                                    <div class="requirements">
                                        Tiene que tener mínimo 13 caracteres
                                    </div>
                                </div>
                            ...
                            <div class="row justify-content-center mg-t-40">
                                <div class="col-lg-7 form__group">
                                    ...
                                    <label class="form__label">Número telefónico<span class="tx-danger">*</span></label>
                                    <div class="requirements">
                            ...
                            <div class="row justify-content-center mg-t-30">
                                <label class="col-lg-7 form-control-label">Comprobante de domicilio (inmobiliaria)<span class="tx-danger">*</span></label>
        ...
        =============================================-->
            <div id="Bancarios" class="tabcontent mg-b-120 mb-lg-260">
                <div class="card form-layout" style="border: none;">
                    <div class="text-center">
                        <h3 class="datos-bancarios-empresa"> Datos bancarios </h3>
                    </div>
                    <form class="" id="form_bancarios_inmobiliaria" enctype="multipart/form-data">
                        ...
                        <div class="row justify-content-center mg-t-40 px-3">
                            <div class="col-lg-7 form__group">
                                <input type="text" class="form__input" id="banco_nombre" name="banco_nombre" pattern="[A-Za-z\s]+" minlength="4" maxlength="30" autocomplete="off" placeholder=" " required>
        ...
        =============================================-->
            <div id="Fiscales" class="tabcontent mg-b-120 height-status-empresa">
                <div class="card form-layout" style="border: none;">
                    <div class="text-center">
                        <h3 class="datos-fiscales-empresa"> Datos fiscales </h3>
                    </div>
                    <form class="" id="form_fiscales" enctype="multipart/form-data">
                        <div class="row justify-content-center mg-t-20 px-3">
                            <div class="col-lg-7 form__group">
                                <input type="text" class="form__input" name="rfc" id="rfc" pattern="^([A-ZÑ\x26]{3,4}([0-9]{2})(0[1-9]|1[0-2])(0[1-9]|1[0-9]|2[0-9]|3[0-1]))([A-Z\d]{3})" minlength="12" maxlength="13" autocomplete="off" placeholder=" " required>
                                <label class="form__label">RFC<span class="tx-danger">*</span></label>
                                <div class="requirements">
                                    No coincide el formato
                                </div>
                        ...
                        <div class="row justify-content-center mg-t-40 px-3">
                            <div class="col-lg-7 form__group">
                                <input type="text" class="form__input" name="direccion_fiscal" id="direccion_fiscal" minlength="13" maxlength="100" autocomplete="off" placeholder=" " required>
        ...
        =============================================-->
            <div id="Notificaciones" class="tabcontent mb-580 mb-sm-327 height-noti-empresa">
                <div class="container">
                    <div class="row">
                        <div class="col-12">
                            <div class="card form-layout" style="border: none;">
                                ...
                                <form id="form_notificaciones" enctype="multipart/form-data">
                                    ...
                                    <div class="mg-t-40">
                                        ...
                                        <div class="col-lg-7 row mx-auto px-0 text-md-right mt-3">
            ...
            ===== MENSAJES  =====
        =============================================-->
            <div id="Mensajes" class="tabcontent  mg-b-120 height-status-empresa">
                <div class="container">
        ...
        =============================================-->
            <div id="Estatus" class="tabcontent mg-b-120 mb-lg-430 height-status-empresa">
                <form id="upd_status" class="pb-5">
                    ...
                    <div class="col-lg-7 row mx-auto px-0 mt-5">
                        <div class="col-sm-8 text-center  pl-lg-0">
                            <div class="d-flex flex-column flex-sm-row justify-content-end">
