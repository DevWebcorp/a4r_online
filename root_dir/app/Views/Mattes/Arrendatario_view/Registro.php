            ...
            <div class="col-12 ">
                ...
                <form class="mg-b-90 mb-lg-4" id="registro" enctype="multipart/form-data">
                    <div class="row justify-content-center mg-t-20 px-3">
                        ...
                        <div class="col-lg-3 mb-lg-4 mg-t-10 mg-sm-t-0">
                    ...
                    <div class="col-lg-4">
                        <div class="form-group">
                            <label class="" for="nombre">Nombre<span class="tx-danger">*</span></label>
                            <input type="text" class="" id="nombre" name="nombre_e" pattern="[a-zA-ZñÑáéíóúÁÉÍÓÚ\s]+" minlength="3" maxlength="25" autocomplete="off" placeholder=" " required>
                        </div>
                    </div>
                    <div class="col-lg-4">
                        <div class="form-group">
                            <label class="" for="p_apellido">Primer apellido<span class="tx-danger">*</span></label>
                            <input type="text" class="" id="p_apellido" name="prim_apellido" pattern="[a-zA-ZñÑáéíóúÁÉÍÓÚ\s]+" minlength="3" maxlength="25" autocomplete="off" placeholder=" " required>
                        </div>
                    </div>
                    <div class="col-lg-4">
                        <div class="form-group">
                            <label class="" for="s_apellido">Segundo apellido<span class="tx-danger">*</span></label>
                            <input type="text" class="" id="s_apellido" name="seg_apellido" pattern="[a-zA-ZñÑáéíóúÁÉÍÓÚ\s]+" minlength="3" maxlength="25" autocomplete="off" placeholder=" " required>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4">
                        <div class="form-group">
                            <label class="" for="phone">Teléfono<span class="tx-danger">*</span></label>
                            <input type="tel" class="" id="phone" autocomplete="off" required>
                        </div>
                    </div>
                    
                    <div class="col-lg-4">
                        <div class="form-group">
                            <label class="" for="f_nac">Fecha de nacimiento<span class="tx-danger">*</span></label>
                            <input type="date" class="" id="f_nac" name="nacimiento" required>
                        </div>
                    </div>
                    <div class="col-lg-4">
                        <div class="form-group">
                            <label class="" for="sexo">Sexo<span class="tx-danger">*</span></label>
                            <select id="sexo" name="sexo" class="" data-placeholder="Selecciona una opción" required>
                    ...
                    <div class="col-lg-12">
                        <div class="form-group">
                            <label class="" for="descripcion">Describete</label>
                            <textarea class="" id="descripcion" name="describete" placeholder=" "></textarea>
                        </div>
                    </div>
                    <div class="col-lg-12">
