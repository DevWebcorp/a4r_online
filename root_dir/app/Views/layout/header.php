...
<header id="header">
    ...
    <!-- HEADER TOP -->
    <div class="header_top" style="background-color: #375470">
        <div class="container">
            ...
            <div class="header_right float-right">
                ...
                <span class="login-register">
                    <a href="<?=base_url()?>/a4r/Login">Entrar</a>
                    <a href="<?=base_url()?>/a4r/Registro">Registrarse</a>
                </span>
            </div>
        </div>
    </div>
            ...
            <nav class="header_menu">
                <ul class="menu">
                    <li class="current-menu-item">
                        <a href="<?=base_url()?>/a4r/Mapa">Inicio </a>
                    </li>
                    <li>
                        <a href="<?=base_url()?>/a4r/Habitaciones_casa">Casas en venta</a>
                    </li>
                    <li>
                        <a href="<?=base_url()?>/a4r/Habitaciones_depto">Habitaciones</a>
                    </li>
                    <!--  <li>
