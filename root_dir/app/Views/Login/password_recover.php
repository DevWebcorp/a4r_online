            ...
            <div class="container">
                <div class="login-register">
                    <div class="text text-center">
                        ...
                        <p>Ingresa tu correo electrónico que registraste para recuperar tu contraseña</p>
                        <form method="POST" action="<?php echo base_url().'/Register/update_password'?>" class="account_form">
                            <?php if (isset($error)) {
                            ...
                            <div class="field-form">
                                <input type="text" class="field-text" name="email" placeholder="Correo electrónico" required>
                            </div>
