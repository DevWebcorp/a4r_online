...
<!-- <div id="landscape">
   <div>
	<p>
	<img src="<?=base_url()?>/../../assets/img/giro@2x.png" height="100%" width="100%"><br>
            ...
            <div class="col-12">
                <div class="d-flex align-items-center justify-content-center  ht-md-100v">
                    <div class="registro wd-400 wd-xs-500 pd-25 pd-xs-40 bg-white">
                        ...
                        <div class="signin-logo tx-38 text-center">Registro propietario</div>
                        <div class="mg-b-30">
                            ...
                            <form method="POST" action="<?=base_url()?>/Registro">
                                ...
                                <!--   <label class="col-sm-4 form-control-label">Contraseña: </label> -->
                                    <div class="col-sm-12 mg-t-10 mg-sm-t-0 input-group" id="show_hide_password2">
                                        <input placeholder="Repite la contraseña"  type="password" class="form-control" name="confirm_password" id="update_password"
                                        required>
                                ...
                                <div class="form-group mt-3 row" style="margin-left: 5px;">
                                    <label><input type="checkbox" name="aviso" id="aviso" class="mr-1" value="" required></label><a href="<?= base_url() ?>/aviso-privacidad">aviso de privacidad</a><p>|</p><a href="<?= base_url() ?>/Terminos-condiciones">Términos y Condiciones</a>
                                </div><!-- form-group -->

                            <!--     <div class="form-group mt-3">
                                    <label><input type="checkbox" name="aviso" id="aviso" class="mr-1" value="" required>Aceptar aviso de privacidad</label>
                                </div> --><!-- form-group -->
                                <input type="hidden" class="form-control" name="propretario" value="3">
