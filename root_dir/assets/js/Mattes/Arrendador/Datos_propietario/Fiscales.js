$(document).ready(function() {
    $(document).on('submit', '#form-fiscales', function() {
        ...
        const url = `${BASE_URL}Mattes/Api/Arrendador_api/Datos_propietario/datos_fiscales`;
...
function get_fiscales() {
    const url = `${BASE_URL}Mattes/Api/Arrendador_api/Datos_propietario/get_fiscales`;
    ...
    $.ajax({
        ...
        success: function(res) {
            ...
            if (res.length > 0) {
                ...
                $('#rfc').val(res[0].rfc);
                $('#fiscal').val(res[0].fiscal_address);
            }
        }
    });
}